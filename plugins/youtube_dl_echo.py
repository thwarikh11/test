...
async def echo(bot, update):
    ...
    if str(update.from_user.id) not in Config.UTUBE_BOT_USERS:
        ...
        if str(update.from_user.id) in Config.ADL_BOT_RQ:
            ...
            display_time = round(Config.FREE_USER + (previous_time - current_time))
            if round(current_time - previous_time) < Config.FREE_USER:
                await bot.send_message(
                    chat_id=update.chat.id,
                    text=Translation.FREE_USER_LIMIT_Q_SZE.format(display_time),
